    ...
    return (
        <div className="max-w-md mx-auto bg-white shadow-md rounded-lg overflow-hidden">
          ...
          <div className="px-6 py-4">
            ...
            <p className="text-gray-700 text-sm mb-2">{cuisines}</p>
            <p className="text-gray-700 text-sm mb-2">{area}</p>
            <p className="text-gray-700 text-sm mb-2">
              Last Mile: {lastMileTravelString}
            </p>
            <p className="text-gray-700 text-sm mb-2">
              Cost for Two: {costForTwoString}
            </p>
  ...
  const Body = () => {
    return (
      <div className="flex-wrap flex justify-between mt-12 px-16">
        {restaurantList.map((restaurant) => {  // here restaurant is object of restaurantList array
